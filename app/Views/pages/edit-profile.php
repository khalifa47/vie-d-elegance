...
<div id="login-and-register-bg" style="height: 600px;background: url(&quot;assets/img/sewing.jpg&quot;) center / cover no-repeat, linear-gradient(rgba(0,0,0,0.4) 100%, rgba(0,0,0,0.4) 100%, white 100%);">
    <div class="form-box">
        ...
        <form id="edit-profile-form" class="inp-grp" method="post" action="/UsersController/edit" style="text-align: center;"><input class="form-control inp-field" type="text" placeholder="First Name" name="fname" required=""><input class="form-control inp-field" type="text" placeholder="Last Name" name="lname" required=""><input class="form-control inp-field" type="email" name="emailadd" placeholder="E-mail" required=""><button class="btn btn-primary" type="submit" style="background: rgb(86,198,198);margin-top: 22px;border-radius: 20px;">Save Changes</button></form>
    </div>
</div>
